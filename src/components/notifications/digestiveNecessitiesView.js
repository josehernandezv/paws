...
export default class digestiveNecessitiesView extends Component {
				...
				<Content>
					<Form>
						<List> 
							...
							<ListItem>
								<Body>
									<Text>Choose the time range you want to be reminded of taking your pet out to satisfy digestive necessities:</Text>
								
									<Picker
										selectedValue={this.state.timeRangeFood}
										onValueChange={(itemValue, itemIndex) => this.setState({timeRangeFood: itemValue})}>
										<Picker.Item label="8 hours" value="12" />
										<Picker.Item label="12 hours" value="24" />
										<Picker.Item label="24 hours" value="36" />
									</Picker>
								</Body>
							</ListItem>
							<ListItem>
								<Body>
									<Text
										style={{marginBottom:20}}>Choose the starting time for the range you want to be reminded of:</Text>
...
module.exports = digestiveNecessitiesView;