...
export default class hairCareView extends Component {
					...
					<Form>
						<List> 
							...
							<ListItem>
								<Body>
									<Text 
										style={{marginBottom:20}}>Choose the date for the next appointment schedule for your pet's healthy hair care routine:</Text>
